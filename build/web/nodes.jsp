                ...
                %>
                    <div class="subject-card" style="opacity: <%= n.isCompleted() ? "0.6" : "1" %>;">
                        <div class="subject-top">
                            ...
                            <% if (!n.isCompleted()) { %>
                                <form action="NodeServlet" method="POST" style="margin:0;">
                                    <input type="hidden" name="action"       value="complete"/>
                                    <input type="hidden" name="nodeId"       value="<%= n.getNodeId() %>"/>
                                    <input type="hidden" name="enrollmentId" value="<%= n.getEnrollmentId() %>"/>
            ...
            <div>
                ...
                <div class="highlight-block mt-3">
                    ...
                    <div class="text-sm text-muted mt-1">
                        Add a node for each topic you need to study. Mark it complete
                        when you are done. Completing a node keeps your daily streak alive.
                    </div>
                </div>
            </div>
